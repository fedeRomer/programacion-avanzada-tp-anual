...
public class Conexion {
	...
	public Connection getConnection() {
		...
		try {
			...
			Connection coneccion1 = DriverManager.getConnection(properties1.getProperty("db.url"),
					properties1.getProperty("db.user"), properties1.getProperty("db.password"));
